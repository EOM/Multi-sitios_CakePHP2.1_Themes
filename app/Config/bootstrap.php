 ...
 */
//Sitios
$sitios = Array('ck2.local' => 'sitio1', 'ck3.local' => 'sitio2');
// 
if (isset($_SERVER['HTTP_HOST']) == TRUE) {
    // Que sitio es..?
    if (isset($sitios[$_SERVER['HTTP_HOST']])) {
        define('SITIO', $sitios[$_SERVER['HTTP_HOST']]);
        App::build(array('Controller' => array(
                ROOT . DS . APP_DIR . DS . 'View' . DS . 'Themed' . DS . SITIO . DS . 'Controller' . DS,
                ROOT . DS . APP_DIR . DS . 'Controller' . DS,
                ))
        );
    } else {
        // No existe el sitio web
        define('SITIO', NULL);
    }
}